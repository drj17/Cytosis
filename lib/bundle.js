...
class Game {
  ...
  generateCircles() {
    for(let i = 0; i < 25; i++){
      let circle = new __WEBPACK_IMPORTED_MODULE_0__circle__["a" /* default */](true);
      this.circles.push(circle);
    }

    setInterval(() => this.circles.push(new __WEBPACK_IMPORTED_MODULE_0__circle__["a" /* default */](false)), 3000);
  }
...
class MovingObject {
  ...
  generateRandomRadius() {
    return Math.floor(Math.random() * (90 - 2)) + 2;
  }
